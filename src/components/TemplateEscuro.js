                    ...
                    return (
                        <div style={{ display: " flex", alignItems: "center" }} className="enunciado mobile inicial">
                            <div style={{ top: "20%", position: "relative" }}>
                                ...
                                <p style={{ position: 'relative', bottom: "4em", fontStyle: "italic" }}>Jardim Medicinal</p>
                            </div>
                        </div>
                    )
                }
            ...
            if (this.props.bolinhas) {
                ...
                return (
                    <div className="enunciado desktop inicial">
                        ...
                        <p style={{ fontSize: '2em', bottom: "1em", position: "relative", fontStyle: "italic" }}>Jardim medicinal</p>
